...
export const LogId = {
    ...
    oauthAuthorizeRequested: mongoLogId(1_006_200),
    oauthLoginSucceeded: mongoLogId(1_006_201),
    oauthLoginFailed: mongoLogId(1_006_202),
    oauthCodeIssued: mongoLogId(1_006_203),
    oauthTokenIssued: mongoLogId(1_006_204),
    oauthTokenRefreshed: mongoLogId(1_006_205),
    oauthRefreshReplayDetected: mongoLogId(1_006_206),
    oauthFamilyRevoked: mongoLogId(1_006_207),
    oauthTokenRevoked: mongoLogId(1_006_208),
    oauthAbsoluteCapExceeded: mongoLogId(1_006_209),
    oauthClientRegistered: mongoLogId(1_006_210),
    oauthStorageLoaded: mongoLogId(1_006_211),
    oauthStorageLoadFailed: mongoLogId(1_006_212),
    oauthStoragePersistFailed: mongoLogId(1_006_213),
    oauthStorageMigratedToEncrypted: mongoLogId(1_006_214),
